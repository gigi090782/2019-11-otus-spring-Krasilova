...
import ru.krasilova.otus.spring.homework10.models.Comment;
...
public class CommentController {
    ...
    public String getViewForListBooksComments(@RequestParam("id") long id,Model model) {
    ...
    public String getViewForEditComment(@RequestParam("id") long id, Model model) {
    ...
    public String getViewForAddComment(@RequestParam("bookid") long bookId, Model model) throws ParseException {
